...
const chalk = require('chalk');
  ...
  bot.user.setActivity("+help - menfou");
});
        ...
        if (command === "gen") {
            if (generated.has(message.author.id)) {
                ...
                const embed = {
                    ...
                    footer: {
                        icon_url:
                            "https://pbs.twimg.com/media/ETySCz3XsAEzBgN.jpg",
                        text: "Développé par menfou"
                    },
                ...
                fs.readFile(filePath, function (err, data) {
                    if (!err) {
                        ...
                        if (position != -1) {
                            ...
                            fs.writeFile(filePath, data, function (err) {
                                const embed = {
                                    ...
                                    timestamp: new Date(),
                                    footer: {
                                        icon_url: "https://pbs.twimg.com/media/ETySCz3XsAEzBgN.jpg",
                                        text: "Développé par menfou"
                                    },
                                    image: {
                                        url:
                        ...
                        const embed = {
                            ...
                            image: {url:"https://i.imgur.com/AD3MbBi.jpeg"},
                            author: {
                                     name: botname + " - générateur de compte",
                                     url: "https://discord.gg/6czZmmtczp",
                                icon_url: bot.displayAvatarURL
            ...
            if (command === "stats") {
                const embed = {
                    ...
                    image: {url:"https://pbs.twimg.com/media/ETySCz3XsAEzBgN.jpg"},
                    author: {
                         name: botname + " - générateur de compte",
                         url: "https://discord.gg/6czZmmtczp",
                        icon_url: bot.displayAvatarURL
